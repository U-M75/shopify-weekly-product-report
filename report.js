  ...
  await sendToSlack({
    blocks: [
      ...
      { type: "section", text: { type: "mrkdwn", text: "*⚠️ Missing Data*" } },
      {
        type: "section",
        fields: [
          { text: stat("🔖", "Barcode",      missingBarcode,     true) },
          { text: stat("🏷️", "SKU",         missingSKU,         true) },
          { text: stat("⚖️", "Weight",       missingWeight,      true) },
          { text: stat("📐", "Size",          missingSize,        true) },
          { text: stat("🖼️", "Image",        missingImage,       true) },
          { text: stat("💰", "Price",         missingPrice,       true) },
          { text: stat("🧾", "Cost",          missingCost,        true) },
          { text: stat("🏷️", "Tags",         missingTags,        true) },
          { text: stat("📁", "Collections",   missingCollections, true) },
          { text: stat("🌐", "HS Code",       missingHSCode,      true) },
        ],
      },
      { type: "divider" },
