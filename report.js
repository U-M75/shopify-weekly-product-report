  ...
  await sendToSlack({
    blocks: [
      ...
      { type: "section", text: { type: "mrkdwn", text: "*⚠️ Missing Data*" } },
      {
        type: "section",
        fields: [
          { text: stat(type: "mrkdwn","🔖", "Barcode",      missingBarcode,     true) },
          { text: stat(type: "mrkdwn","🏷️", "SKU",         missingSKU,         true) },
          { text: stat(type: "mrkdwn","⚖️", "Weight",       missingWeight,      true) },
          { text: stat(type: "mrkdwn","📐", "Size",          missingSize,        true) },
          { text: stat( type: "mrkdwn","🖼️", "Image",        missingImage,       true) },
          { text: stat( type: "mrkdwn","💰", "Price",         missingPrice,       true) },
          { text: stat( type: "mrkdwn","🧾", "Cost",          missingCost,        true) },
          { text: stat( type: "mrkdwn","🏷️", "Tags",         missingTags,        true) },
          { text: stat( type: "mrkdwn","📁", "Collections",   missingCollections, true) },
          { text: stat( type: "mrkdwn","🌐", "HS Code",       missingHSCode,      true) },
        ],
      },
      { type: "divider" },
